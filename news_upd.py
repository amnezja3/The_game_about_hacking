...
userAlive.dataUserCREATE6("today_news", txt_user)
userAlive.dataUserDELETE('today_news', txt_user, 'kolumna6', 'del')

listNewsTitle = userAlive.dataGeneral('news', "title")
listNewsContent = userAlive.dataGeneral('news', "content")
# listNewsDownload = userAlive.dataGeneral('news', "zalacznik")
listNewsData = userAlive.dataGeneral('news', "data")

listRoundRange = userAlive.mixer(4, 9)
listRoundStart = userAlive.mixer(0, 9)



for news in range(listRoundRange):
    listNewsDownload = userAlive.mixer(0, 11)
    if listNewsDownload == 1:
        download = 'download'
    else:
        download = 'empty'
            
    userAlive.dataUserINSERT6('today_news', txt_user, listNewsTitle[news], listNewsData[news], listNewsContent[news], download, '', 'del')
    news += listRoundStart
...
class Obszar_Roboczy:
    def __init__(self, root, txt_user, session):
        ...
        self.root.geometry("480x420+1020+360")
        ...
        self.list_oznaczone_news_tytul = userAlive.dataGeneral('today_news' + self.txt_user, "kolumna1")
        self.list_oznaczone_news_data = userAlive.dataGeneral('today_news' + self.txt_user, "kolumna2")
        self.list_oznaczone_news_opis = userAlive.dataGeneral('today_news' + self.txt_user, "kolumna3")
        self.list_oznaczone_news_download = userAlive.dataGeneral('today_news' + self.txt_user, "kolumna4")
